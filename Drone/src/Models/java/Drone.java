...
public class Drone extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    public Drone(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        Drone model = new Drone();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Drone Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Drone.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Drone.class.getResource(".").toString());
        }
